...
const Login = () => {
    ...
    return (
        <center>
        <div className="row g-0 auth-wrapper center">
            <div className="col-12 col-md-5 col-lg-6 h-100 auth-background-col center">
                <div className="auth-background-holder"></div>
                <div className="auth-background-mask"></div>
            </div>

            <div className="col-12 col-md-7 col-lg-6 auth-main-col center">
                <div className="d-flex flex-column align-content-end center">
                    <div className="auth-body mx-auto center">
                        <p>Login to your account</p>
                        <div className="auth-form-container text-start center">
